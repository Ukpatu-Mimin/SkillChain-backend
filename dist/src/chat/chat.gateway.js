...
let ChatGateway = ChatGateway_1 = class ChatGateway {
    ...
    async handleMessage(payload, client) {
        try {
            const message = await this.chatService.sendMessage(payload.senderId, payload.conversationId, payload.text, payload.attachmentUrl, payload.attachmentType);
    ...
    async handleMarkRead(payload, _client) {
